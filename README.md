...
```c
#include "stdlib/stats/base/dists/gumbel/pdf.h"
```

#### stdlib_base_dists_gumbel_pdf( x, mu, beta )
...
```c
double stdlib_base_dists_gumbel_pdf( const double x, const double mu, const double beta );
```
